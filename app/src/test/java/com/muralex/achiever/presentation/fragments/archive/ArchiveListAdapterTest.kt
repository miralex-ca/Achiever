...
class ArchiveListAdapterTest {

    private lateinit var context: Context
    private val archiveAdapter = ArchiveListAdapter()
    ...
    fun onCreateViewHolder_returnViewHolder() {
        val viewHolder = archiveAdapter.onCreateViewHolder(frameLayout,1)
        assertThat(viewHolder).isInstanceOf(ArchiveListAdapter.ViewHolder::class.java)
    }

    @Test
    fun bindViewHolder_defaultList_InitialState() {
        val holder =  ArchiveListAdapter.ViewHolder.from(frameLayout)
